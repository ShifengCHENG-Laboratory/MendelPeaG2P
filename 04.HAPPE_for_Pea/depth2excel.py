...
normaldepth="/public/agis/chengshifeng_group/jiangmei/practices/code/HAPPE_for_pea/normalization_depth_from_mosdepth_output.py"
part_len="/vol3/agis/chengshifeng_group/jiangmei/pea/03.happe/03.SdCol/call.snp/partlen.txt"
...
if __name__ == "__main__":
    ...
    inf.close()
    chro = chromosome
    if chro not in ["chrUn" ,"chr1","chr2","chr4"]:
